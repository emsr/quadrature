...
Definition at line 225 of file gauss\+\_\+jacobi\+\_\+interface.\+tcc.


\begin{DoxyCode}{0}
\DoxyCodeLine{226     \{}
\DoxyCodeLine{227       std::vector<Tp> f(this-\/>\mbox{\hyperlink{structjac__quadrature_a20d0db1598e72081e68da49ad0524551}{Q}});}
\DoxyCodeLine{228       \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < this-\/>\mbox{\hyperlink{structjac__quadrature_a20d0db1598e72081e68da49ad0524551}{Q}}; ++i)}
\DoxyCodeLine{229         f[i] = fun(this-\/>x[i]);}
\DoxyCodeLine{230       \textcolor{keywordflow}{return} std::inner\_product(std::begin(this-\/>w), std::end(this-\/>w),}
\DoxyCodeLine{231                                 std::begin(f), \mbox{\hyperlink{test__integral_8tcc_a82f489a4943d33943d0b0f781a801283}{Tp}}\{0\});}
\DoxyCodeLine{232     \}}
