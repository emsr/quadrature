...
template<typename Tp>
  ...
  test_integral(Tp proto = Tp{})
  {
    ...
    auto mq = __gnu_cxx::double_exp_integrate4<fun_t, Tp>(fun, 20, Tp{0}, PI, Tp{0.0000001});
    std::cout << mq << '\n';
    ...
    Tp a0 = __gnu_cxx::double_exp_integrate4<decltype(one), Tp>(one, 20, a, b, err);
    Tp e0 = b - a;
    std::cout << "one     : "
	      << ' ' << std::setw(w) << a0
	      << ' ' << std::setw(w) << e0
    ...
    Tp a1 = __gnu_cxx::double_exp_integrate4<decltype(ex), Tp>(ex, 20, a, b, err);
    Tp e1 = (b * b - a * a) / Tp{2};
    std::cout << "ex      : "
	      << ' ' << std::setw(w) << a1
	      << ' ' << std::setw(w) << e1
    ...
    Tp a2 = __gnu_cxx::double_exp_integrate4<decltype(cos2), Tp>(cos2, 20, a, b, err);
    Tp e2 = PI / Tp{2};
    std::cout << "cos2    : "
	      << ' ' << std::setw(w) << a2
	      << ' ' << std::setw(w) << e2
    ...
    Tp a3 = __gnu_cxx::double_exp_integrate4<decltype(sin2), Tp>(sin2, 20, a, b, err);
    Tp e3 = PI / Tp{2};
    std::cout << "sin2    : "
	      << ' ' << std::setw(w) << a3
	      << ' ' << std::setw(w) << e3
    ...
    Tp a4 = __gnu_cxx::double_exp_integrate4<decltype(j1), Tp>(j1, 20, a, b, err);
    ...
    a = Tp{0};
    b = Tp{10} * PI;
    Tp a5 = __gnu_cxx::double_exp_integrate4<decltype(foo), Tp>(foo, 20, a, b, err);
    ...
    Tp a5n = __gnu_cxx::double_exp_integrate4<decltype(foonum), Tp>(foonum, 20, a, b, err);
    ...
    Tp a6 = __gnu_cxx::double_exp_integrate4<__gnu_cxx::_Polynomial<Tp>, Tp>(poly1, 20, a, b, err);
    ...
    a = Tp{0};
    b = PI;
    Tp a7 = __gnu_cxx::double_exp_integrate4<decltype(funk1), Tp>(funk1, 20, a, b, err);
    Tp e7 = Tp{0};
    std::cout << "funk1   : "
	      << ' ' << std::setw(w) << a7
	      << ' ' << std::setw(w) << e7
    ...
    Tp a7n = __gnu_cxx::double_exp_integrate4<decltype(funk1num), Tp>(funk1num, 20, a, b, err);
    Tp e7n = Tp{0};
    std::cout << "funk1num: "
	      << ' ' << std::setw(w) << a7n
	      << ' ' << std::setw(w) << e7n
    ...
    Tp a8 = __gnu_cxx::double_exp_integrate4<decltype(funk2), Tp>(funk2, 20, a, b, err);
    Tp e8 = Tp{0};
    std::cout << "funk2   : "
	      << ' ' << std::setw(w) << a8
	      << ' ' << std::setw(w) << e8
    ...
    Tp a8n = __gnu_cxx::double_exp_integrate4<decltype(funk2num), Tp>(funk2num, 20, a, b, err);
    Tp e8n = Tp{0};
    std::cout << "funk2num: "
	      << ' ' << std::setw(w) << a8n
	      << ' ' << std::setw(w) << e8n
