/*
LD_LIBRARY_PATH=..:$LD_LIBRARY_PATH $HOME/bin/bin/g++ -std=gnu++17 -g -Wall -Wextra -Wno-psabi -I../include -I../polynomial/include -o build_double_exp_rules build_double_exp_rules.cpp -lquadmath -L../wrappers/debug -lwrap_burkhardt -lgfortran
