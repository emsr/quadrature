...
namespace __gnu_cxx
{
  ...
  template<typename _Tp, typename _FuncTp>
    _Tp
    tanh_sinh_integrate1(_FuncTp __func, _Tp __a, _Tp __b, _Tp /*__max_rel_tol*/)
    {
      int __n = 16;
      __n /= 2;
  ...
  template<typename _Tp, typename _FuncTp>
    _Tp
    tanh_sinh_integrate2(_FuncTp __func, _Tp __a, _Tp __b, _Tp /*__max_rel_tol*/)
    {
      int __n = 16;
      __n /= 2;
  ...
  template<typename _Tp, typename _FuncTp>
    ...
    tanh_sinh_integrate3(_FuncTp __func, _Tp __a, _Tp __b, _Tp /*__max_rel_tol*/)
    {
      int __n = 16;
      __n /= 2;
