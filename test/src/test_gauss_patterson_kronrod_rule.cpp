/*
g++ -std=c++14 -Wall -Wextra -Iinclude -o test_gauss_patterson_kronrod_rule test_gauss_patterson_kronrod_rule.cpp
*/
...
#include <emsr/gauss_kronrod_rule.tcc>

template<typename Tp>
  void
  test_gauss_patterson_kronrod_rule()
  {
...
main()
{
  ...
  //test_gauss_patterson_kronrod_rule<float>();

  //std::cout << "\n\nTesting double Gauss-Fronrod rule ...\n\n";
  //test_gauss_patterson_kronrod_rule<double>();

  std::cout << "\n\nTesting long double Gauss-Fronrod rule ...\n\n";
  test_gauss_patterson_kronrod_rule<long double>();
}
